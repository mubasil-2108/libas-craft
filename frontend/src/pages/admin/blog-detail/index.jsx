...
import { createBlog, deleteBlog, getBlogById } from '../../../store/slices/blogSlice';
            ...
            <Box component='div' sx={{
                ...
                <Box sx={{ display: 'flex', width: '100%', flexDirection: 'column', gap: 2 }}>
                    ...
                    <Box sx={{ display: 'flex', width: '100%', flexDirection: 'column', gap: 2 }}>
                        ...
                        <TiptapEditor
                            key={blog?._id || 'new'}  // 👈 forces remount when blog loads
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'right', flexWrap: 'wrap', flexDirection: { xs: 'column', sm: 'row' }, gap: 2 }}>
                        ...
                        <Button variant='contained' disabled={isLoading || isPackageLoading || isDeleting || isUpdating || isImageDeleting} loading={handleDelete} sx={{ minWidth: 150, background: colors.primary }} onClick={handleDeletePackage}>Delete</Button>
