                ...
                <Grid container spacing={3}>
                    ...
                    <Grid item size={6} xs={12} sm={6} md={6} lg={6} >
                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                            ...
                            {/* Buttons */}
                            <Box sx={{ display: 'flex', justifyContent: 'space-between', flexDirection: { xs: 'column', sm: 'row' }, gap: 2 }}>
                                <Button variant='contained' sx={{ minWidth: 150, background: '#232321' }}>Update</Button>
                                <Button variant='contained' sx={{ minWidth: 150, background: '#003F62' }}>Delete</Button>
                                <Button variant='outlined' sx={{ minWidth: 150, borderColor: '#232321', color: '#232321' }}>Cancel</Button>
                            </Box>
                        </Box>
                    </Grid>
                </Grid>
