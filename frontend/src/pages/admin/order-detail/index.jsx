        ...
        <Box component='div' sx={{
            ...
            <Box component='div' sx={{
                ...
                <Box component='div' sx={{
                    ...
                    <Box component='div' sx={{ display: 'flex', gap: 2, alignItems: 'center', flexDirection: 'row' }}>
                        <Typography component='p' sx={{ color: colors.textColor_3, fontWeight: 700, fontSize: '20px' }}>Orders ID:{' '}
                            <Typography component='span' sx={{ color: colors.textColor_3, fontWeight: 700, fontSize: '20px' }}>#6743</Typography>
                        </Typography>
                        <Chip label="Pending" sx={{ background: colors.orangeLight_80, color: colors.textColor_3, borderRadius: '10px', fontSize: '12px', fontWeight: 600 }} />
                    </Box>
                        ...
                        <Box component='div' sx={{ display: 'flex', alignItems: 'center', flexDirection: 'row', gap: 2 }}>
                            <Box component='div' sx={{
                                ...
                                >
                                    ...
                                    <MenuItem onClick={() => handleStatusChange('Pending')} sx={{ gap: 1.5 }}><Icon fontSize='inherit' sx={{ fontSize: '14px', color: colors.iconColor_4 }} component={FiberManualRecordIcon} /> Pending</MenuItem>
                                    <Divider variant='middle' />
                                    <MenuItem onClick={() => handleStatusChange('Cancelled')} sx={{ gap: 1.5 }}><Icon fontSize='inherit' sx={{ fontSize: '14px', color: colors.iconColor_8 }} component={FiberManualRecordIcon} /> Cancelled</MenuItem>
                                </Menu>
                            </Box>
                            <IconButton sx={{ background: colors.iconBgColor_3, p: '12px 15px', borderRadius: '10px' }}><Icon fontSize='medium' component={PrintOutlinedIcon} /></IconButton>
                            <IconButton sx={{ background: colors.iconBgColor_3, p: '12px 15px', borderRadius: '10px' }}><Typography component='p' sx={{ color: colors.textColor_3, fontSize: '14px', fontWeight: 500 }}>Save</Typography></IconButton>
                        </Box>
                    </Box>
                    <Grid container columnSpacing={{ xs: 1, sm: 2, md: 3, lg: 2 }} sx={{ mt: 2 }}>
                            ...
                            <Box component='div' sx={{ display: 'flex', flexDirection: 'column', gap: 2, minWidth: '280px', borderRadius: '15px', border: `1px solid ${colors.borderColor_5}`, p: '15px 20px' }}>
                                <Box component='div' sx={{ display: 'flex', flexDirection: 'row', gap: 2 }}>
                                    ...
                                    <Box component='div' sx={{ display: 'flex', flexDirection: 'column', flexGrow: 1, flexShrink: 1, gap: 1 }}>
                                        ...
                                        <Typography cpmonent='p' sx={{ color: colors.textColor_1, fontSize: '16px', fontWeight: 600 }}>Full Name: Shristi Singh</Typography>
                                        <Typography cpmonent='p' sx={{ color: colors.textColor_1, fontSize: '16px', fontWeight: 600 }}>Email: shristi@gmail.com</Typography>
                                        <Typography cpmonent='p' sx={{ color: colors.textColor_1, fontSize: '16px', fontWeight: 600 }}>Phone: +91 904 231 1212</Typography>
                        ...
                        <Grid item xs={12} sm={6} md={6}>
                            <Box component='div' sx={{ display: 'flex', flexDirection: 'column', gap: 2, minWidth: '280px', borderRadius: '15px', border: `1px solid ${colors.borderColor_6}`, p: '15px 20px' }}>
                                <Box component='div' sx={{ display: 'flex', flexDirection: 'row', gap: 2 }}>
                                    <Box component='div' sx={{
                                        display: 'flex',
                                        justifyContent: 'center',
                                    ...
                                    <Box component='div' sx={{ display: 'flex', flexDirection: 'column', flexGrow: 1, flexShrink: 1, gap: 1 }}>
                                        ...
                                        <Typography cpmonent='p' sx={{ color: colors.textColor_1, fontSize: '16px', fontWeight: 600 }}>Shipping: Next express</Typography>
                                        <Typography cpmonent='p' sx={{ color: colors.textColor_1, fontSize: '16px', fontWeight: 600 }}>Payment Method: Paypal</Typography>
                                        <Typography cpmonent='p' sx={{ color: colors.textColor_1, fontSize: '16px', fontWeight: 600 }}>Status: Pending</Typography>
                ...
                <Box component='div' sx={{ display: 'flex', flexDirection: 'row', gap: 2, mt: 2 }}>
                    <Box component='div' sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', gap: 1, minWidth: '280px', borderRadius: '15px', border: `1px solid ${colors.borderColor_6}`, p: '15px 20px' }}>
                        <Typography cpmonent='p' sx={{ color: colors.textColor_3, fontSize: '20px', fontWeight: 600 }}>Deliver to</Typography>
                        <Box component='div' sx={{ display: 'flex', flexDirection: 'row', gap: 2, alignItems: 'center' }}>
                            ...
                            <Typography cpmonent='p' sx={{ color: colors.textColor_1, fontSize: '16px', fontWeight: 600 }}>Master Card **** **** 6557</Typography>
                        </Box>
                        <Typography cpmonent='p' sx={{ color: colors.textColor_1, fontSize: '16px', fontWeight: 600 }}>Business name: Shristi Singh</Typography>
                        <Typography cpmonent='p' sx={{ color: colors.textColor_1, fontSize: '16px', fontWeight: 600 }}>Phone: +91 904 231 1212</Typography>
                    </Box>
                    <Box>
                        <Typography cpmonent='p' sx={{ color: colors.textColor_3, fontSize: '20px', fontWeight: 600 }}>Note</Typography>
                        <Box component='div' sx={{ display: 'flex', flexDirection: 'column', minWidth: '650px', borderRadius: '15px', border: `1px solid ${colors.borderColor_6}`, p: '10px 5px' }}>
                            <TextField multiline rows={4} placeholder='Type some notes' sx={{
                                ...
                                '& .MuiInputBase-input': {
                                    '::placeholder': {
                                        color: colors.placeholderColor_1,
                                        fontSize: '16px',
                                    },
                                },
                            }} />
            ...
            <Box component='div' sx={{
                                ...
                                productOrders.length > 0 ? sortedOrders.map((product) => {
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell align='center' sx={{ fontSize: '14px', fontWeight: 600, color: colors.black, }}>{product.orderId}</TableCell>
                                            <TableCell align='center' sx={{ fontSize: '14px', fontWeight: 600, color: colors.black, }}>{product.qty}</TableCell>
                                            <TableCell align='center' sx={{ fontSize: '14px', fontWeight: 600, color: colors.black, }}></TableCell>
                                            <TableCell align='center' sx={{ fontSize: '14px', fontWeight: 600, color: colors.black, }}></TableCell>
                                            <TableCell align='center' sx={{ fontSize: '14px', fontWeight: 600, color: colors.black, }}></TableCell>
                                            <TableCell sx={{ fontSize: '14px', fontWeight: 600, color: colors.black }} align="right">₹{product.total}</TableCell>
                                        </TableRow>
                                    )
                                })
                                    :
                ...
                <Box component='div' sx={{ display: 'flex', flexDirection: 'column', gap: 2, alignItems: 'end', mt: 4, }}>
                    <Box component='div' sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', width: '100%', maxWidth: '450px' }}>
                        ...
                        <Typography component='p' sx={{ color: colors.textColor_3, fontSize: '16px', fontWeight: 600, ml: 1 }}>₹{subtotal.toFixed(2)}</Typography>
                    </Box>
                    <Box component='div' sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', width: '100%', maxWidth: '450px' }}>
                        <Typography component='p' sx={{ color: colors.textColor_3, fontSize: '16px', fontWeight: 600 }}>Discount</Typography>
                        <Typography component='p' sx={{ color: colors.textColor_3, fontSize: '16px', fontWeight: 600, ml: 1 }}>₹{discount.toFixed(2)}</Typography>
                    </Box>
                    <Box component='div' sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', width: '100%', maxWidth: '450px' }}>
                        <Typography component='p' sx={{ color: colors.textColor_3, fontSize: '16px', fontWeight: 600 }}>Shipping Rate</Typography>
                        <Typography component='p' sx={{ color: colors.textColor_3, fontSize: '16px', fontWeight: 600, ml: 1 }}>₹{shippingRate.toFixed(2)}</Typography>
                    </Box>
                    <Box component='div' sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', width: '100%', maxWidth: '450px' }}>
                        <Typography variant='h4' component='p' sx={{ color: colors.textColor_3, fontWeight: 600 }}>Total</Typography>
                        <Typography variant='h4' component='p' sx={{ color: colors.textColor_3, fontWeight: 600, ml: 1 }}>₹{total.toFixed(2)}</Typography>
                    </Box>
                </Box>
            </Box>
        </Box >
