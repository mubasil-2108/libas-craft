...
const { createProduct, getAllProducts, getProductById, updateProduct, deleteProduct, getProductsByCategory, searchProducts, deleteProductImage } = require("../controllers/product");
